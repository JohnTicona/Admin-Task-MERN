  ...
  return (
    <header className='px-4 py-5 bg-white border-b'>
      <div className='md:flex md:justify-between'>
        ...
        /> */}
        <div className='flex justify-evenly items-center gap-6 mt-5 md:mt-0'>
          <Link to='/proyectos' className='font-bold uppercase'>Ver Proyectos</Link>

          <button onClick={handleLogout} type='button' className='text-white text-sm bg-red-600 p-3 rounded-md uppercase font-bold'>
            Cerrar Sesión
          </button>
        </div>
      </div>
